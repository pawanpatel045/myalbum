...
if(isset($_GET['current']))
{
    ...
    if($updateResult)
    {
      ...
      header('location:nalbum.php?updated=true&val='.$curr.'');
...
if(isset($_SESSION['email']) && $_SESSION['email'] == "admin@gmail.com")
{
  ...
  echo '<a class="btn btn-success my-4" href="addalbum.php?albumType=0">Add New Album</a>';
}
?>
  ...
  <div class="card-body">
    ...
    <?php
      if(isset($_SESSION['email']) && $_SESSION['email'] == "admin@gmail.com")
      {
        ...
        echo '<a href="nalbum.php?current='. $button .'&albumid='.$detail['id'].' " class="btn btn-success ">'.$button.'</a>';
      }
    ?>
    <?php
   echo '</div>
